...
namespace MvcBankingApplication.Controllers
{
  public class CashiersController : Controller
  {
    ...
    public async Task<IActionResult> Edit(int id, [Bind("TransactionLimit,StaffId,IsAdmin,ID,ImageUrl,Password,Username,FirstName,LastName")] CashierModel cashierModel)
    {
